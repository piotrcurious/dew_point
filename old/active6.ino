...
const float CO2Factor = 0.003;
const float SO2Factor = 0.005;
const float NO2Factor = 0.004;

// Nonlinear scaling factors for contaminants
const float CO2NonlinearFactor = 1.5;
const float SO2NonlinearFactor = 1.3;
const float NO2NonlinearFactor = 1.4;
...
// Function to apply nonlinear gas effects on dew point
...
// Function to adjust for combined gas effects
float adjustDewPointForContaminantsNonlinear(float dewPoint, float co2Deviation, float so2Deviation, float no2Deviation) {
  dewPoint = adjustDewPointForGasNonlinear(dewPoint, co2Deviation, CO2Factor, CO2NonlinearFactor);
  dewPoint = adjustDewPointForGasNonlinear(dewPoint, so2Deviation, SO2Factor, SO2NonlinearFactor);
  return adjustDewPointForGasNonlinear(dewPoint, no2Deviation, NO2Factor, NO2NonlinearFactor);
}

// Adaptive cooling function using feedback
...
// Function to create the cooling profile and collect data
...
// Improved polynomial fitting function with error analysis
